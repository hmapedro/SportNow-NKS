...
namespace SportNow.CustomViews
{
    public class FormValue : Border
    {
        ...
        {
            createFormValue(text, 45 * App.entryHeightAdapter, App.formValueFontSize, Colors.Transparent, App.normalTextColor, TextAlignment.Start);
        }

        public FormValue(string text, int fontSize, Color backgroundColor, Color textColor, TextAlignment textHorizontalAlignment)
        {
            createFormValue(text, 35 * App.entryHeightAdapter, App.formValueFontSize, backgroundColor, textColor, textHorizontalAlignment);
        }
